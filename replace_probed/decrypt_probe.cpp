...
#define REL_STATIC_REACH_FUNCS_FILE "debloat/pin_probe_debloat_experiments/libc/staticReachableFuncs"
...
void init_statically_reachable_funcs(void)
{
    ...
    if(rv >= STATIC_REACH_FUNCS_FILE_SZ){
        PRINTF_FLUSH("ERROR: path to static reachability functions file is too" \
