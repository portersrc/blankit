//
// Usage:
// ./a.out <your .so with the text section that you want writable>
//
// This solution is taken verbatim from here:
// https://stackoverflow.com/questions/21638871/objcopy-writable-text-not-making-elf-binary-text-section-writable
//
// I never tried the suggestion to link with -N
//
// I tried the objcopy --writable-text suggestion from here:
// https://stackoverflow.com/questions/8794555/how-can-i-make-gcc-compile-the-text-section-as-writable-in-an-elf-binary
// It didn't work,
// and that's what led me to use this helper code
