...
MAX_ADDR_LIBCRYPTO      = 0x18d384
MAX_ADDR_LIBUTIL        = 0x1710
MAX_ADDR_LIBRESOLV      = 0x132c0
MAX_ADDR_LIBSSH         = 0x56540
MAX_ADDR_LIBNSS_COMPAT  = 0x6bfc
MAX_ADDR_LIBNSL         = 0x111ec
MAX_ADDR_LIBNSS_NIS     = 0x88b4
MAX_ADDR_LIBNSS_FILES   = 0x82ac
...
class LibDetails:
    def __init__(self, name, max_addr):
        ...
        self.routine_list = "../../approved_lists/complete-routine-lists/%s_routine_list.txt" % name
...
call_chains_file = "../longest_call_chain/string2id_map.csv"

libs = [
	LibDetails("libc", MAX_ADDR_LIBC),
	LibDetails("libcrypto", MAX_ADDR_LIBCRYPT),
	LibDetails("libdl", MAX_ADDR_LIBDL),
	LibDetails("libutil", MAX_ADDR_LIBUTIL),
	LibDetails("libz", MAX_ADDR_LIBZ),
	LibDetails("libcrypt", MAX_ADDR_LIBCRYPT),
	LibDetails("libresolv", MAX_ADDR_LIBRESOLV),
	LibDetails("libssh", MAX_ADDR_LIBSSH),
	LibDetails("libnss_compat", MAX_ADDR_LIBNSS_COMPAT),
	LibDetails("libnsl", MAX_ADDR_LIBNSL),
	LibDetails("libnss_nis", MAX_ADDR_LIBNSS_NIS),
	LibDetails("libnss_files", MAX_ADDR_LIBNSS_FILES)
]
