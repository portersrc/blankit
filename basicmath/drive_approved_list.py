...
# called_funcs_in_<benchmark>.txt. To really run this, we need the glibc list.
with open("called_funcs_in_basicmath_small.txt", "r") as f:
#with open("/home/rudy/debloat/pin_probe_debloat_experiments/libc/glibc_routine_list.txt", "r") as f:
    for line in f:
